      ...
      <ThemeProvider theme={theme}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <Tabs centered textColor="primary" indicatorColor="primary" value={value} onChange={handleChange} aria-label="basic tabs example">
            <Tab icon={<Icon as={AiOutlineDesktop} boxSize={25} />} label="Laptop View" {...a11yProps(1)} />
            <Tab icon={<Icon as={MdTabletMac} boxSize={25} />} label="Tablet View" {...a11yProps(2)} />
            <Tab icon={<Icon as={MdOutlinePhoneAndroid} boxSize={25} />} label="Smart Phone View" {...a11yProps(0)} />
          </Tabs>
        </Box>
        <TabPanel value={value} index={0}>
          <div className={style.video} data-aos="slide-left" data-aos-duration="1000" data-aos-easing="ease-in-out">
            <video width="820" height="540" autoPlay muted loop>
        ...
        <TabPanel value={value} index={2} data-aos="slide-left" data-aos-duration="1000" data-aos-easing="ease-in-out">
